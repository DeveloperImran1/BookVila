...
const AddProducts = () => {
    ...
    const handleSubmit = async e => {
        ...
        const category = e.target.productType.value;
        ...
        // validation 
        if (!title || !price || !totalAvailable || !description || !category || !color || !photo || !offer) {
        ...
        axiosPublic.post('/product', productData)
            .then(data => {
                ...
                swal("Success", "You have successfully added a Product", "success")
    ...
    return (
        <div className="flex justify-center items-center flex-col">
            <form onSubmit={handleSubmit} className="flex  flex-col lg:px-6 lg:py-8 w-full lg:w-[65%] space-y-6   border-2 border-[#5A5A5D] rounded-[16px] ">
                {/* <div>
                    {
                        <img alt="" className="w-[100%] h-[200px] md:h-[300px] lg:h-[500px]  rounded shadow-sm col-span-2 row-span-2  dark:bg-gray-500 " src="hjkh" />
                    }
                ...
                <label className="">
                    ...
                    <input type="text" name="title" placeholder="Product Title" className=" w-full   rounded-tr-lg rounded-bl-lg hover:rounded-md shadow-sm focus:ring focus:ring-opacity-75 border-2 border-[#5A5A5D] p-2 focus:dark:ring-primary dark:bg-gray-100 " />
                </label>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center" >
                    ...
                    <label className="w-full px-6 lg:px-0 lg:w-[45%]">
                        ...
                        <input type="number" placeholder="Price" name="price" className=" w-full   rounded-tr-lg rounded-bl-lg hover:rounded-md shadow-sm focus:ring focus:ring-opacity-75 border-2 border-[#5A5A5D] p-2 focus:dark:ring-primary dark:bg-gray-100 " />
                    </label>
                    <label className="w-full px-6 lg:px-0 lg:w-[45%]" >
                        <span className="mb-1">Total</span>
                        <input type="text" name="total" placeholder="Total Available" className=" w-full   rounded-tr-lg rounded-bl-lg hover:rounded-md shadow-sm focus:ring focus:ring-opacity-75 border-2 border-[#5A5A5D] p-2 focus:dark:ring-primary dark:bg-gray-100 " />
                    </label>
                ...
                <div className="flex flex-col md:flex-row  justify-between" >
                    <label className="w-full px-6 lg:px-0 lg:w-[45%]" >
                        ...
                        <input type="number" name="offer" placeholder="Offer of percentage" className=" w-full   rounded-tr-lg rounded-bl-lg hover:rounded-md shadow-sm focus:ring focus:ring-opacity-75 border-2 border-[#5A5A5D] p-2 focus:dark:ring-primary dark:bg-gray-100 " />
                    </label>
                    <label className="w-full px-6 lg:px-0 lg:w-[45%]" >
                        <span className="mb-1">Weight</span>
                        <input type="text" name="weight" placeholder="Product Weight" className=" w-full   rounded-tr-lg rounded-bl-lg hover:rounded-md shadow-sm focus:ring focus:ring-opacity-75 border-2 border-[#5A5A5D] p-2 focus:dark:ring-primary dark:bg-gray-100 " />
                    </label>
                </div>
                ...
                <label className="">
                    ...
                    <textarea type="text" name="description" placeholder="Product Description" className=" w-full  h-[90px] rounded-tr-lg rounded-bl-lg hover:rounded-md shadow-sm focus:ring focus:ring-opacity-75 border-2 border-[#5A5A5D] p-2 focus:dark:ring-primary dark:bg-gray-100 " />
                </label>


                <button type="submit" className="rounded-lg  border-2 border-primary px-8 py-3 text-xl text-primary duration-200 hover:bg-primary hover:text-white">Add Product</button>
