...
const Footer = () => {
    return (
        <div>
            <footer
                className=" text-black dark:text-white mt-[100px] mb-[30px] ">
                <div className=" space-y-6 divide-y dark:divide-gray-600 md:space-y-12 divide-opacity-50 relative">
                    <div className="grid grid-cols-12">
                        <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
                            <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 md:justify-start">
                                ...
                                <span className="self-center text-2xl font-semibold"> Edust It Limeted </span>
                            </a>
                        </div>
                        <div className="col-span-6 text-center md:text-left md:col-span-3">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-600">Students
                                        Name</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-600">className Page</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-600">Students
                                        Name</a>
                        ...
                        <div className="col-span-6 text-center md:text-left md:col-span-3">
                            ...
                            <ul>
                                <li><Link className="hover:dark:text-violet-600"></Link>Home</li>
                                <li><Link className="hover:dark:text-violet-600"></Link>Servicess</li>
                                <li><Link className="hover:dark:text-violet-600"></Link>Home</li>
                                <li><Link className="hover:dark:text-violet-600"></Link>Home</li>
                                <li><Link className="hover:dark:text-violet-600"></Link>Home</li>
                    ...
                    <div className="grid justify-center pt-6 lg:justify-between">
                        <div className="flex flex-col self-center text-sm text-center md:block lg:col-start-1 md:space-x-6">
                            <span>©2024 Edust It Limeted All rights reserved <a
                                href="https://www.facebook.com/DeveloperImran1">Imran Hassan</a></span>
